<template>
    <div class="flex flex-col w-screen h-screen">
        ...
        <NuxtLink class="absolute bottom-0 right-0" external="external" to="https://github.com/blackburn32/simple-piano">
...
const keys: Record<string, KeyController> = {
    'a': {
        ...useSound('/simple-piano/sounds/a.mp3', defaultSoundOptions),
        domRef: a,
        sharp: false,
        keyboardKey: 'h',
        name: 'a',
    ...
    'a#': {
        ...useSound('/simple-piano/sounds/aSharp.mp3', defaultSoundOptions),
        domRef: aSharp,
        sharp: true,
        keyboardKey: 'u',
        name: 'a#',
    ...
    'b': {
        ...useSound('/simple-piano/sounds/b.mp3', defaultSoundOptions),
        domRef: b,
        sharp: false,
        keyboardKey: 'j',
        name: 'b',
    ...
    'c': {
        ...useSound('/simple-piano/sounds/c.mp3', defaultSoundOptions),
        domRef: c,
        sharp: false,
        keyboardKey: 'a',
        name: 'c',
    ...
    'c#': {
        ...useSound('/simple-piano/sounds/cSharp.mp3', defaultSoundOptions),
        domRef: cSharp,
        sharp: true,
        keyboardKey: 'w',
        name: 'c#',
    ...
    'd': {
        ...useSound('/simple-piano/sounds/d.mp3', defaultSoundOptions),
        domRef: d,
        sharp: false,
        keyboardKey: 's',
        name: 'd',
    ...
    'd#': {
        ...useSound('/simple-piano/sounds/dSharp.mp3', defaultSoundOptions),
        domRef: dSharp,
        sharp: true,
        keyboardKey: 'e',
        name: 'd#',
    ...
    'e': {
        ...useSound('/simple-piano/sounds/e.mp3', defaultSoundOptions),
        domRef: e,
        sharp: false,
        keyboardKey: 'd',
        name: 'e',
    ...
    'f': {
        ...useSound('/simple-piano/sounds/f.mp3', defaultSoundOptions),
        domRef: f,
        sharp: false,
        keyboardKey: 'f',
        name: 'f',
    ...
    'f#': {
        ...useSound('/simple-piano/sounds/fSharp.mp3', defaultSoundOptions),
        domRef: fSharp,
        sharp: true,
        keyboardKey: 't',
        name: 'f#',
    ...
    'g': {
        ...useSound('/simple-piano/sounds/g.mp3', defaultSoundOptions),
        domRef: g,
        sharp: false,
        keyboardKey: 'g',
        name: 'g',
    ...
    'g#': {
        ...useSound('/simple-piano/sounds/gSharp.mp3', defaultSoundOptions),
        domRef: gSharp,
        sharp: true,
        keyboardKey: 'y',
        name: 'g#',
